    ...
    <div class="max-w-md w-full">
      ...
      <form class="space-y-4" @submit.prevent="$router.push({ name: 'dashboard' })">
        ...
        <div>
          <button
            type="submit"
            class="grouprelativew-fullflexjustify-centerpy-4px-6border border-transparentfont-mediumrounded-mdtext-whitebg-indigo-600hover:bg-indigo-700focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            Sign in
          </button>
        </div>
